...
class AllConfig implements IConfig {
	 ...
	 */
	public function __construct(SystemConfig $systemConfig, EventDispatcher $eventDispatcher = null) {
	...
	public function setUserValue($userId, $appName, $key, $value, $preCondition = null) {
		...
		$arguments = [
			'user' => $userId, 'key' => $key, 'value' => $value,
	...
	public function deleteUserValue($userId, $appName, $key) {
		...
		$arguments = ['user' => $userId, 'key' => $key, 'app' => $appName];
